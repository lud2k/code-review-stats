...
const styles = require('./commits-graph.css')
...
export class CommitsGraph extends React.Component<{ changes: Change[] },
    ...
    renderSvg() {
        ...
        const simulation = d3.forceSimulation<Node>()
            ...
            .force('charge', d3.forceManyBody().strength((d: any) => d.type === 'project' ? -200 : -200))
        ...
        return (
            <Grid item xs={12} sm={12}>
                <Paper>
                    ...
                    <svg width='1000' height={this.state.height} ref={(ele) => this.ele = ele}
